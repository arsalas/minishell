...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/portable-ruby/2.6.8_1")
  ...
  CONFIG["configure_args"] = " '--build=x86_64-apple-darwin17.7.0' '--host=x86_64-apple-darwin15.0.0' '--prefix=/usr/local/Cellar/portable-ruby/2.6.8_1' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=tk,sdbm,gdbm,dbm' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' 'MJIT_CC=/usr/bin/clang' '--with-readline-dir=/usr/local/opt/portable-readline' '--with-libyaml-dir=/usr/local/opt/portable-libyaml' '--with-openssl-dir=/usr/local/opt/portable-openssl' 'build_alias=x86_64-apple-darwin17.7.0' 'host_alias=x86_64-apple-darwin15.0.0' 'CC=clang' 'LDFLAGS=-Wl,-search_paths_first' 'CXX=clang++'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-search_paths_first -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-search_paths_first -fstack-protector-strong -L/usr/local/opt/portable-readline/lib -L/usr/local/opt/portable-libyaml/lib -L/usr/local/opt/portable-openssl/lib -L/usr/local/lib"
  ...
  CONFIG["host_os"] = "darwin15.0.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin15.0.0"
  ...
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = "x86_64-apple-darwin15.0.0"
  CONFIG["build_alias"] = "x86_64-apple-darwin17.7.0"
  CONFIG["LIBS"] = ""
  CONFIG["ECHO_T"] = ""
  CONFIG["ECHO_N"] = ""
  CONFIG["ECHO_C"] = "\\\\c"
